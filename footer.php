			...
			<div id="bottombar">
				...
				<a href="http://crossfit.com" target="_blank"><img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/logo-crossfit.jpg" alt="CrossFit" /></a>
				...
				<a href="http://sitesasrx.com" target="_blank"><img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/logo-sitesasrx-sx-footer-v2.png" alt="SitesAsRx" /></a>
